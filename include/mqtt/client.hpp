...
template <typename Socket, typename PacketId = std::uint16_t>
class client : public endpoint<Socket, std::mutex, std::lock_guard, PacketId> {
    using this_type = client<Socket, PacketId>;
    using base = endpoint<Socket, std::mutex, std::lock_guard, PacketId>;
public:
     ...
     * @return client object
     */
    friend std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>>
     ...
     * @return client object
     */
    friend std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>>
     ...
     *  strand is controlled by ws_endpoint, not endpoint, so client has null_strand template argument.
     */
    friend std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>>
     ...
     * @return client object
     */
    friend std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>>
     ...
     * @return client object
     */
    friend std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>>
     ...
     * @return client object
     */
    friend std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>>
     ...
     *  strand is controlled by ws_endpoint, not endpoint, so client has null_strand template argument.
     */
    friend std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>>
     ...
     * @return client object
     */
    friend std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>>
...
inline std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>>
make_client_32(as::io_service& ios, std::string host, std::string port) {
    struct impl : client<tcp_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls)
        : client<tcp_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>(ios, std::move(host), std::move(port), tls) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), false);
}
...
inline std::shared_ptr<client<tcp_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>>
make_client_no_strand_32(as::io_service& ios, std::string host, std::string port) {
    struct impl : client<tcp_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls)
        : client<tcp_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>(ios, std::move(host), std::move(port), tls) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), false);
}
...
inline std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>>
make_client_ws_32(as::io_service& ios, std::string host, std::string port, std::string path = "/") {
    struct impl : client<ws_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls,
             std::string path)
            :
            client<ws_endpoint<as::ip::tcp::socket, as::io_service::strand>, std::uint32_t>
            (ios, std::move(host), std::move(port), tls, std::move(path)) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), false, std::move(path));
}
...
inline std::shared_ptr<client<ws_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>>
make_client_no_strand_ws_32(as::io_service& ios, std::string host, std::string port, std::string path = "/") {
    struct impl : client<ws_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls,
             std::string path)
            :
            client<ws_endpoint<as::ip::tcp::socket, null_strand>, std::uint32_t>
            (ios, std::move(host), std::move(port), tls, std::move(path)) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), false, std::move(path));
}
...
inline std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>>
make_tls_client_32(as::io_service& ios, std::string host, std::string port) {
    struct impl : client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls)
        : client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>(ios, std::move(host), std::move(port), tls) {}
    };
    return std::make_shared<impl>
        (std::ref(ios), std::move(host), std::move(port), true);
}
...
inline std::shared_ptr<client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>>
make_tls_client_no_strand_32(as::io_service& ios, std::string host, std::string port) {
    struct impl : client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls)
        : client<tcp_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>(ios, std::move(host), std::move(port), tls) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), true);
}
...
inline std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>>
make_tls_client_ws_32(as::io_service& ios, std::string host, std::string port, std::string path = "/") {
    struct impl : client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls,
             std::string path)
            :
            client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, as::io_service::strand>, std::uint32_t>
            (ios, std::move(host), std::move(port), tls, std::move(path)) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), true, std::move(path));
}
...
inline std::shared_ptr<client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>>
make_tls_client_no_strand_ws_32(as::io_service& ios, std::string host, std::string port, std::string path = "/") {
    struct impl : client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t> {
        impl(as::io_service& ios,
             std::string host,
             std::string port,
             bool tls,
             std::string path)
            :
            client<ws_endpoint<as::ssl::stream<as::ip::tcp::socket>, null_strand>, std::uint32_t>
            (ios, std::move(host), std::move(port), tls, std::move(path)) {}
    };
    return std::make_shared<impl>(std::ref(ios), std::move(host), std::move(port), true, std::move(path));
}
